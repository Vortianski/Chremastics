...
public class TradersInsigniaItem extends Item implements ICurioItem {
    public TradersInsigniaItem() {
        super(
                new Properties()
                        .stacksTo(1)
        );
    ...
    public void appendHoverText(@NotNull ItemStack itemStack, @NotNull TooltipContext tooltipContext, @NotNull List<Component> tooltipComponents, @NotNull TooltipFlag tooltipFlag) {
        tooltipComponents.add(Component.translatable("chremastics.tooltip.traders_insignia", ClientData.getBentCoinChance() * 100).withStyle(style -> style.withColor(ChatFormatting.GRAY)));
